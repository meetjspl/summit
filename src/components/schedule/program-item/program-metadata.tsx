...
export const ProgramMetadata = ({
	...
	return (
		<div className="flex min-w-0 flex-wrap items-center justify-start gap-2">
			...
			{showLiveBadge && (
				<span className="inline-flex shrink-0 items-center justify-center rounded-full border border-black/12 bg-meetjs-green/95 px-2.5 py-0.5 text-xs font-extrabold tracking-[0.08em] text-[rgba(19,20,24,0.98)]">
					LIVE
				</span>
			)}

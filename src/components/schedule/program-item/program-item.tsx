...
export const Program = (props: ProgramProps) => {
  ...
  const { image, title, since, till, description, linkedinUrl, githubUrl } = data;
  ...
  const stackPadding = isVertical ? "py-0.5 px-0.5 pb-1.5" : "py-1.5 px-1.5 pl-0.5";
  ...
  const renderLayout = () => {
    ...
    return <ProgramDesktopLayout {...commonProps} stackPadding={stackPadding} />;
  };

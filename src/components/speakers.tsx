...
const speakers: Speaker[] = [
	...
	},
	{
		...
		company: 'WebWorks',
		talkTitle: 'Modern React Patterns and Performance',
		bio: 'Jan is a React expert and contributes to several open-source projects in the JavaScript ecosystem.',
		social: {
			twitter: '#',
			linkedin: '#',
		},
	},
	{
		...
		talkTitle: 'Kubernetes at Scale: Lessons Learned',
		bio: 'Maria has architected cloud infrastructure for Fortune 500 companies and is a CNCF ambassador.',
		social: {
			linkedin: '#',
			github: '#',
		},
	},
	{
		...
		role: 'Tech Lead',
		company: 'StartupHub',
		talkTitle: 'From Monolith to Microservices',
		bio: 'Piotr has led multiple successful migrations and shares insights from real-world experiences.',
		social: {
			twitter: '#',
			github: '#',
		},
